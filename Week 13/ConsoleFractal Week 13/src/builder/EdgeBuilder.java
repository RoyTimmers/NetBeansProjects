...
public class EdgeBuilder implements Observer {
    ...
    private void binarySave(Object e) throws FileNotFoundException, IOException {
        FileOutputStream fos = new FileOutputStream("C:\\Users\\royti\\OneDrive\\Documenten\\NetBeansProjects\\Week 13\\Edges\\edge.bin", true);
    ...
    private void textSave(Object e) throws IOException {
        FileWriter fw = new FileWriter("C:\\Users\\royti\\OneDrive\\Documenten\\NetBeansProjects\\Week 13\\Edges\\edge.txt", true);
        Edge edge = (Edge) e;
        if (first) {
    ...
    private void MMFSave(Object e) throws IOException {
        ...
        RandomAccessFile ras = new RandomAccessFile("C:\\Users\\royti\\OneDrive\\Documenten\\NetBeansProjects\\Week 13\\Edges\\edge.ras", "rw");
